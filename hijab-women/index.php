...
include '../config.php';
            ...
            $sql = "SELECT `product_id`, `product_name1`, `product_name2`, `product_image`, `product_category`, `product_desc`, `product_price`
                    FROM `product`
                    WHERE `product_category` = 'hijab-women'";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../femalestyle.css" />
...
<?php require "../navbar.php" ?>
                ...
                <div class="cards__wrapper">
                    ...
                    <div class="card current--card">
                        <div class="card__image">
                            <img src="../img/female/Pleats Scarf in Cocoon.jpg" alt="" />
                        </div>
                    </div>

                    <div class="card next--card">
                        <div class="card__image">
                            <img src="../img/female/Frappe Shawl in Roar.jpg" alt="" />
                        </div>
                    </div>

                    <div class="card previous--card">
                        <div class="card__image">
                            <img src="../img/female/Instant Jersey Hijab Lightweight Stretchable.jpg" alt="" />
                        </div>
                    </div>
                </div>
    ...
    <div class="container-create">
        <div class="main-text">
            <div class="heading">
                <h2>
                    <span id="create">appear in a beautiful </span>
                </h2>
                <h2>
                    <span id="create">and beautiful version</span>
                </h2>
                <h2>
