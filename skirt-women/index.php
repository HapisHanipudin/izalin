                ...
                <div class="cards__wrapper">
                    ...
                    <div class="card current--card">
                        <div class="card__image">
                            <img src="../img/female/Hijab Style Inspiration bikin ngiler para kaum adam.jpg" alt="" />
                        </div>
                    </div>

                    <div class="card next--card">
                        <div class="card__image">
                            <img src="../img/female/Women's Pleated Long Skirt - khaki _ One Size.jpg" alt="" />
                        </div>
                    </div>

                    <div class="card previous--card">
                        <div class="card__image">
                            <img src="../img/female/Outfit aesthetic.jpg" alt="" />
                        </div>
                    </div>
                </div>
